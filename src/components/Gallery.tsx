        ...
        >
          ...
          {[...images, ...images].map((src, index) => (
            <motion.div
              ...
              className="relative w-[300px] h-[400px] md:w-[400px] md:h-[500px] flex-shrink-0 rounded-[2rem] overflow-hidden glass-dark border-white/10 group/card cursor-pointer"
            >
              <img 
                src={src} 
                alt={`Gallery ${index}`} 
